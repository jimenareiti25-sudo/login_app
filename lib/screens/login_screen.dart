...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    // Asignación de roles por ID de usuario
    String assignedRole;
...
// --- RESULTADO DE AUTENTICACIÓN PARA MANEJAR ERRORES DE RED ---
class AuthResult {
  ...
  static Future<AuthResult> authenticateUser(String username, String password) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return AuthResult(errorMessage: 'Error en el servidor. Intenta más tarde.');
      }
    } on SocketException {
      return AuthResult(errorMessage: 'Sin conexión a internet. Verifica tu red.');
    } on TimeoutException {
      return AuthResult(errorMessage: 'Tiempo de espera agotado. Verifica tu conexión.');
    } catch (e) {
      return AuthResult(errorMessage: 'Sin conexión a internet. Verifica tu red.');
    }
  }
